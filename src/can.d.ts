declare module "can" {
    ...
    declare class RawChannel {
        constructor(name: string, timestamps: boolean, protocol: number, non_block_send: boolean);
         ...
         */
        addListener(event: string, callback: CallableFunction, instance: object);
         ...
         */
        setErrorFilters(errorMask: number);
