...
describe('signals', function() {
    ...
    it('should properly decode little endian', function(done) {
        ...
        assert.deepEqual(signals.decode_signal(data, 0, 8, true, false), [0xDE, 0]);
        assert.deepEqual(signals.decode_signal(data, 0, 12, true, false), [0xDDE, 0]);
        assert.deepEqual(signals.decode_signal(data, 0, 16, true, false), [0xADDE, 0]);
        assert.deepEqual(signals.decode_signal(data, 0, 24, true, false), [0xBEADDE, 0]);
        assert.deepEqual(signals.decode_signal(data, 0, 32, true, false), [0xEFBEADDE, 0]);
        assert.deepEqual(signals.decode_signal(data, 0, 64, true, false), [0xEFBEADDE, 0xBEBAFECA]);

        assert.deepEqual(signals.decode_signal(data, 12, 8, true, false), [0xEA, 0]);
        assert.deepEqual(signals.decode_signal(data, 12, 12, true, false), [0xBEA, 0]);
        assert.deepEqual(signals.decode_signal(data, 12, 20, true, false), [0xEFBEA, 0]);

        assert.deepEqual(signals.decode_signal(data, 0, 1, true, false), [0, 0]);
        assert.deepEqual(signals.decode_signal(data, 1, 1, true, false), [1, 0]);
        assert.deepEqual(signals.decode_signal(data, 2, 1, true, false), [1, 0]);
        assert.deepEqual(signals.decode_signal(data, 3, 1, true, false), [1, 0]);
    ...
    it('should properly decode signed little endian', function(done) {
        ...
        assert.deepEqual(signals.decode_signal(data, 8, 8, true, true), [-1, 0]);
        assert.deepEqual(signals.decode_signal(data, 0, 16, true, true), [-2, 0]);
        assert.deepEqual(signals.decode_signal(data, 16, 8, true, true), [-128, 0]);

        data = Buffer.from([0xFF, 0xFF, 0xFF, 0xFF]);
        assert.deepEqual(signals.decode_signal(data, 0, 32, true, true), [-1, 0]);
    ...
    it('should properly decode big endian', function(done) {
        ...
        assert.deepEqual(signals.decode_signal(data, 0, 8, false, false), [0xDE, 0]);
        assert.deepEqual(signals.decode_signal(data, 0, 16, false, false), [0xDEAD, 0]);

        assert.deepEqual(signals.decode_signal(data, 7, 8, false, false), [0x56, 0]);
        assert.deepEqual(signals.decode_signal(data, 15, 16, false, false), [0xDF77, 0]);

        assert.deepEqual(signals.decode_signal(data, 0, 1, false, false), [1, 0]);
        assert.deepEqual(signals.decode_signal(data, 1, 1, false, false), [1, 0]);
        assert.deepEqual(signals.decode_signal(data, 2, 1, false, false), [0, 0]);
        assert.deepEqual(signals.decode_signal(data, 3, 1, false, false), [1, 0]);
    ...
    it('should properly decode signed big endian', function(done) {
        ...
        assert.deepEqual(signals.decode_signal(data, 0, 8, false, true), [-1, 0]);
        assert.deepEqual(signals.decode_signal(data, 0, 16, false, true), [-2, 0]);
        assert.deepEqual(signals.decode_signal(data, 16, 8, false, true), [-128, 0]);
        assert.deepEqual(signals.decode_signal(data, 16, 16, false, true), [-32767, 0]);
